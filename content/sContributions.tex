...
This section begins by showing the process of using the built Tagger Comparing System (\ref{TaggerSystem}) to tag $100,000$ articles from Signal's 1M Dataset in \ref{TaggingSignal}.
This will consist of explaining the decisions taken for tagger parameters and level of concurrency.
After this, the system's performance will be evaluated using the general metrics in AWS CloudWatch.
...
\subsubsection{Setting up an Amazon EMR Spark Cluster}
