...
\subfloat[Stanford per type]{\csvautotabular{data/stanford_per_type.csv}}
\subfloat[Spotlight per type]{\csvreader[%
  respect all,%
  autotabular%
  ]{data/spotlight_per_type.csv}{}{\csvlinetotablerow}}
\subfloat[NIL per type]{\csvautotabular{data/nil_per_type.csv}}
